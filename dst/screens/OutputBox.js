...
const OutputBox = ({ lines, active, maxVisible, contentWidth }) => {
    ...
    const thumbPos = maxOffset > 0 ?
        ...
        0;
    return (_jsxs(Box, { flexDirection: 'row', borderStyle: 'round', borderColor: 'cyan', width: contentWidth, children: [_jsx(Box, { flexDirection: 'column', flexGrow: 1, paddingLeft: 1, children: visible.map((line, i) => _jsx(Text, { children: line }, offset + i)) }), needBar ?
